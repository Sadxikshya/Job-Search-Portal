                    ...
                    <div class="flex-1">
                        <div class="flex items-start justify-between gap-3 mb-3">
                            ...
                            <span class="flex-shrink-0 px-2.5 py-0.5 text-xs font-medium rounded
                                @if($job->job_type === 'full-time') bg-green-50 text-green-700 border border-green-200
                                @elseif($job->job_type === 'part-time') bg-blue-50 text-blue-700 border border-blue-200
                                @elseif($job->job_type === 'contract') bg-orange-50 text-orange-700 border border-orange-200
                                @elseif($job->job_type === 'internship') bg-purple-50 text-purple-700 border border-purple-200
